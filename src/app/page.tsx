          ...
          {trendingComics.length > 0 ? (
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-background via-background/90 to-transparent z-10 w-full md:w-3/4" />
                <div className="absolute right-0 top-0 bottom-0 w-full md:w-3/4 opacity-40 md:opacity-80 z-0">
                  <img
                ...
                <div className="relative z-20 mx-auto w-full max-w-[1400px] px-4 md:px-8 flex items-center h-full">
                  <div className="w-full md:w-3/5 py-12 flex flex-col gap-5 items-start">
                    ...
                    <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-foreground leading-tight line-clamp-2 drop-shadow-xl">
                      {trendingComics[currentSlide].title}
                    </h1>
                    
                    <p className="text-sm md:text-base text-muted-text max-w-lg leading-relaxed font-medium line-clamp-3 drop-shadow-md">
            ...
            <>
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-background via-background/90 to-transparent z-10 w-full md:w-3/4" />
              <div className="absolute right-0 top-0 bottom-0 w-full md:w-3/4 opacity-35 md:opacity-75 z-0">
                <img
